...
class UrlsControllerTest < ActionController::TestCase
  ...
  test "should create url" do
    assert_difference('Url.count') do
      post :create, url: { UUID: @url.UUID, alias: @url.alias, http: @url.http, user_id: @url.user_id }
    end
  ...
  test "should update url" do
    patch :update, id: @url, url: { UUID: @url.UUID, alias: @url.alias, http: @url.http, user_id: @url.user_id }
    assert_redirected_to url_path(assigns(:url))
  end
